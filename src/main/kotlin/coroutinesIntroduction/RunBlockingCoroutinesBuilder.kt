...
fun main() = runBlocking {  // Execute in CoroutinesIntroduction.CoroutinesIntroduction.CoroutinesIntroduction.CoroutinesIntroduction.main thread.
    ...
    val jobDeferred: Deferred<Int> = GlobalScope.async {  // CoroutinesIntroduction.CoroutinesIntroduction.CoroutinesIntroduction.CoroutinesIntroduction.main Thread.
        ...
        15  // either T1 or other thread running.
    }
    ...
    // jobDeferred.join() note that to cancel the coroutine, we call job.cancel().
